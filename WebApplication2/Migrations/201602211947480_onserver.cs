namespace WebApplication2.Migrations
{
    ...
    public partial class onserver : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        QuestionID = c.Guid(),
                        PostedTime = c.DateTime(nullable: false),
                        OfferedFees = c.Double(nullable: false),
                        Status = c.String(),
                        NewMessageTutor = c.Boolean(nullable: false),
                        NewMessageStudent = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        Usera_SessionId = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.ConnectionID)
                .ForeignKey("dbo.Useras", t => new { t.Usera_UserName, t.Usera_SessionId })
                .Index(t => new { t.Usera_UserName, t.Usera_SessionId });
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.UserName, t.SessionId });
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transactions", "SessionID", "dbo.Sessions");
            ...
            DropIndex("dbo.Transactions", new[] { "SessionID" });
